...
import (
	...
	"github.com/microsoft/scylla/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CoreV1alpha1Interface interface {
	RESTClient() rest.Interface
	OperationalConfigurationsGetter
}

// CoreV1alpha1Client is used to interact with features provided by the core.hydra.io group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) OperationalConfigurations(namespace string) OperationalConfigurationInterface {
	return newOperationalConfigurations(c, namespace)
}
